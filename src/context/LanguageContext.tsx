...
const translations = {
  EN: {
    ...
    'rivals.title': 'Rivalry Hub',
    'rivals.desc': 'Track the heat between massive club fanbases',
  ...
  AR: {
    ...
    'rivals.title': 'مركز المنافسات',
    'rivals.desc': 'تتبع الحرارة بين قواعد جماهير الأندية الضخمة',
